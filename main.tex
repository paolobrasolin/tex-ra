...
\begin{document} % ################################################ BOOK START #
  ...
  \backmatter % =================================================== END MATTER =
    ...
    \begin{adjustwidth}{0.25\textwidth}{0.25\textwidth}
      \centering
Printed in September 2015 by Blurb.
This book is set using typefaces from the Linux Libertine family
designed by Philipp Poll and the devan\=agar\=\i\ font by Frans Velthuis.
    \end{adjustwidth}
    \vfill
    \cleartoverso % ----------------------------------------------------- leaf -
    \null
